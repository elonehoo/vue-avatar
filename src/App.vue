...
import Accesories  from './components/layout/accesories.vue'
import Clothes     from './components/layout/clothes.vue'
import Eyebrows    from './components/layout/eyebrows.vue'
import Eyes        from './components/layout/eyes.vue'
import Facialhair  from './components/layout/facialhair.vue'
import Glasses     from './components/layout/glasses.vue'
import Hair        from './components/layout/hair.vue'
import Mounths     from './components/layout/mouths.vue'
import SkinColor   from './components/layout/SkinColor.vue'
import Tattoos     from './components/layout/tattoos.vue'

// import options color
import OptionsColor from './components/optionsColor.vue'

// import footer
import Footer from './components/footer.vue'

// Github icon component
import Github from './components/layout/githubIcon.vue'
